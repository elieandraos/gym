...
- `testing-strategy` — Testing strategy and conventions for this Laravel project. Activate whenever working on a PHP test file — writing, editing, fixing, or refactoring tests.
- `actions-strategy` — Actions pattern conventions for this Laravel project. Activate whenever writing or editing an Action class in app/Actions/.
- `laravel-php-coding-conventions` — PHP coding style conventions for this Laravel project. Activate when writing or editing any PHP file — controllers, models, tests, requests, etc. Covers import style, PHPStorm annotations, and other project-specific PHP conventions.
