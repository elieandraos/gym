<template>
    <div class="relative custom-select">
        <select
            ...
            ref="selectInput"
            v-bind="$attrs"
            class="py-2 pl-2 pr-8 text-sm border border-zinc-200 hover:border-zinc-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg bg-none cursor-pointer appearance-none"
