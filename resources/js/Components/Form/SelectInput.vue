<template>
    <div class="relative custom-select">
        <select
            ...
            ref="selectInput"
            v-bind="$attrs"
            class="py-2 pl-2 pr-8 text-sm border border-zinc-200 hover:border-zinc-300 rounded-lg focus:outline-none focus:ring-0 bg-none cursor-pointer appearance-none"
